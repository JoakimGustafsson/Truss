...
class PropertyList {
	...
	constructor() {
		...
		this.forceLimitProperty = new NumberProperty('forceLimit', 'forceLimit', 'Force Limit', ParameterCategory.CONTENT, 'When the force generated by the tensor exceeds theis limit a behaviour is triggered. For example a breaking of the tensor.');
